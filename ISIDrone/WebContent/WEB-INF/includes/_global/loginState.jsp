...
if(user != null) {
%>
<%if(user.getType_user().equals("admin")){%>
    <li id="loginState">	
	<ul id="userAction" class="list-unstyled navbar navbar-default">
            <li><a href="listProducts">Liste de produits</a></li>
            <li><a href="listCategories">List de Categories</a></li>
             <li><a href="newProductsAdmin">Ajouter produits</a></li>
             <li><a href="newCategory">Ajouter category</a></li>
             <li><a href="historiqueC">Afficher list des commandes </a></li>
