...
public class Items extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ActionCategory.getCategories(request, response);
                String StrREsearch= request.getParameter("recherche");
//                System.out.println("el STRReseach es " +StrREsearch);
                if(StrREsearch!=null){
//                    System.out.println("je suis dans le if dans items.java le mot es " +StrREsearch);
                    ActionItems.getItemsSearch(StrREsearch, request, response);
                }else{
                    ActionItems.getItems(request, response);
//                    System.out.println("je suis dans le else dans items.java le mot es " +StrREsearch);
                }
