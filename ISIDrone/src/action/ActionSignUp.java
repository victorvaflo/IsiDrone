...
//			user.setType_user(hm_formParamValue.get("type_user"));
...
//		validation.addRestriction("type_user", restrict1);
	...
	private static String getErrorMsg(ResultValidation resValid) {
		...
		switch(resValid.getKey()) {
			...
			case "confirmPassword":
				...
				break;
//			case "type_user":
//				errorMsg += getErrorMsgForTypeUser(resValid);
//				break;
			case "addr_no":
...
//	private static String getErrorMsgForTypeUser( ResultValidation resValid) {
//		String errorMsg = "";
//		
//		switch(resValid.getCode()) {
//			case 1:
//				errorMsg += "Vous devez choissir un type de user.\n";
//				break;
//			case 2:
//			case 3:
//			case 4:
//			case 5:
//				errorMsg += "Le type user ne correspond pas.";
//				break;
//		}
//		
//		return errorMsg;
