...
public class MSignUp {
	...
	public static int signUp(User user) {
		int code = isExist(user);
		          System.out.println("MSignUp " + code);
		if(code == 1) {
			try {
				MDB.connect();
				...
				String query = "INSERT INTO user (`lastName`, `firstName`, `email`, `password`, `ship_address_id`, `type_user`) VALUES (?, ?, ?, ?, ?, ?)";
				...
				ps.setInt(5, user.getShipAddress().getId());
                                ...
                                System.out.println("Les info d'inscription");
                                System.out.println("" +user.getLastName());
				System.out.println("" +user.getFirstName());
				System.out.println("" + user.getEmail());
				System.out.println("" + Hash.SHA1(user.getPassword()));
                                System.out.println("" + user.getType_user());
				System.out.println("" + user.getShipAddress().getId());
				ps.executeUpdate();
