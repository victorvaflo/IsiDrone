...
public class Const {
    ...
    public static String PATH_PAGE_EDITCATEGORY = PATH_PRIVATE + "editCategory.jsp";
    ...
    public static String PATH_PAGE_PRODUCTSADMIN = PATH_PRIVATE + "newProduct.jsp";
    public static String PATH_PAGE_LISTCATEGORIES = PATH_PRIVATE + "listCategories.jsp";

    public static String PATH_PAGE_NEWCATEGORIES = PATH_PRIVATE + "newCategory.jsp";

    public static String PATH_PAGE_POPUP = PATH_PRIVATE + "popup.jsp";
    public static String PATH_HISTORIQUE_COMMANDE = PATH_PRIVATE + "listOrders.jsp";

    public static String PATH_PAGE_DELETEPOPUP = PATH_PRIVATE + "deletePopup.jsp";
    public static String PATH_PAGE_DELETECATEGORY = PATH_PRIVATE + "listCategories.jsp";
    public static String PATH_PAGE_CATEGORIESACTIVES = PATH_PRIVATE + "categoriesActive.jsp";
    public static String PATH_PAGE_DELETEORDER = PATH_PRIVATE + "deleteOrder.jsp";
    // Index
    public static String PATH_MENU_BANNER = PATH_INDEX_INCLUDES + "banner.jsp";
